...
{
    public class CoverageTypeService : BaseService<CoverageTypeDTO, CoverageType>, ICoverageTypeService
    {
        public CoverageTypeService(ICoverageTypeRepository repository, IMapper mapper, IUnitOfWork unitOfWork)
